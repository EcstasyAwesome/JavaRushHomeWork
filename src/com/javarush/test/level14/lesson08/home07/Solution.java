...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for(Object room:apartaments){
            if (room instanceof Apt1Room) ((Apt1Room) room).clean1Room();
            else if (room instanceof Apt2Room) ((Apt2Room) room).clean2Rooms();
            else if (room instanceof Apt3Room) ((Apt3Room) room).clean3Rooms();
        }
    }
