...
public class Solution {
    ...
    public static final class Constants{
        static final String SERVER_NOT_ACCESSIBLE = "Server is not accessible for now.";
        static final String UNAUTHORIZED_USER = "User is not authorized.";
        static final String BANNED_USER = "User is banned.";
        static final String RESTRICTION = "Access is denied.";
    }
